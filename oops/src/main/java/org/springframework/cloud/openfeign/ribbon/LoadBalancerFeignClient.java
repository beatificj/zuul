...
public class LoadBalancerFeignClient implements Client {
	...
	public Response execute(Request request, Request.Options options) throws IOException {
		try {
			...
			FeignLoadBalancer lb = lbClient(clientName);
			log.error("lbClient [{}]", lb.getClass().getName());
			return lb.executeWithLoadBalancer(ribbonRequest, requestConfig).toResponse();
		}
